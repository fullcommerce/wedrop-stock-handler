...
const delete_1 = __importDefault(require("../core/functions/delete"));
function PaymentMethods(api, raw) {
    const config = {
        api,
        raw,
    ...
    return Object.assign(config, {
        ...
        find: new find_1.default().find,
        findBy: new findBy_1.default().findBy,
        create: new create_1.default().create,
        update: new update_1.default().update,
        delete: new delete_1.default().delete
    });
}
